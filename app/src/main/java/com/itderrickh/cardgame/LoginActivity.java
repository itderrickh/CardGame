...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (isEmpty || !isPasswordValid(password)) {
        ...
        if (cancel) {
            ...
            if(isRegistering) {
                ...
                Intent mainPage = new Intent(this.getApplicationContext(), MainActivity.class);
                mainPage.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                mainPage.putExtra("email", mEmailView.getText().toString());
                startActivity(mainPage);
            } else {
                if(mEmailView.getText().toString().equals("Erik") && mPasswordView.getText().toString().equals("Krohn1")) {
                    showProgress(true);
